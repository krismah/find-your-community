...
public class ProfileList {
    ...
    public void addProfile(Profile profile) {
        ...
        EventLog.getInstance().logEvent(new Event(profile.getName() + " was added to your list! \n"));
    }
    ...
    public void removeProfile(Profile profile) {
        ...
        EventLog.getInstance().logEvent(new Event(profile.getName() + " was removed from your list. \n"));
    }
